...
export default function IntegrationsTab({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <StaticCard
        name="Slack"
        description="Triage Slack mentions into the inbox. Wired in Session 5."
      />
      <StaticCard
        name="Google"
        description="Calendar + Gmail for meeting prep and email triage. Wired in Sessions 5-6."
      />
      <StaticCard
        name="Anthropic"
...
function TelegramCard({
  ...
  state: IntegrationsState["telegram"];
}) {
